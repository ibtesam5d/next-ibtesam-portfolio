    ...
    <section id='about' className='mt-[7rem] h-screen md:h-full'>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 py-10 gap-8 relative">
            ...
            <div className="lg:col-span-2 realtive">
                ...
                <a href="#contact" className='px-4 py-2 border-[2px] border-[#4db5ff] text-gray-900 rounded-md bg-[#4db5ff] hover:bg-white hover:text-gray-900 hover:border-white'>My Projects</a>
                <a href="#projects" className='px-4 py-2 border-[2px] border-[#4db5ff] text-gray-900 rounded-md bg-[#4db5ff] hover:bg-white hover:text-gray-900 hover:border-white'>Contact Me</a>
                </div>
