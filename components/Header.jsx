  ...
  return (
    <header className="pt-[7rem] h-screen overflow-hidden">
        <div className="text-center h-full relative">
            ...
            {/*===== Portfolio Image ====*/}
            <div className="bg-gradient-to-b from-[#4db5ff] to-[transparent] md:w-72 md:h-[25rem] w-64 h-[20rem] rounded-t-full absolute overflow-hidden mt-8" style={{left: `calc(50% - 8rem`}}>
                <Image className="object-cover mx-auto mt-11" src="/images/Portrait.png" width={250} height={250} alt="ibtesam's photo" />
            </div>
