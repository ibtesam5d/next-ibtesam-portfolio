...
const Header = () => {
  return (
    <header className="pt-[7rem] h-screen overflow-hidden">
        <div className="text-center h-full relative">
            ...
            <div className="my-[2.5rem] flex gap-[1.2rem] lg:gap-10 justify-center">
                <a href="" className="px-2 md:px-4 py-3 border-[2px] border-[#4db5ff] text-[#4db5ff] rounded-md hover:bg-white hover:text-gray-900 hover:border-white">Download Resume</a>
                <a href="" className="px-2 md:px-4 py-3 border-[2px] border-[#4db5ff] text-gray-900 rounded-md bg-[#4db5ff] hover:bg-white hover:text-gray-900 hover:border-white">Contact Me</a>
            </div>
            {/* ====== Social Links ======= */}
